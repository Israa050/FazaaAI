...
class _ApiService implements ApiService {
  ...
  @override
  Future<String> createNewUser(User user) async {
  ...
  Future<List<Shelter>> getAllShelters() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<Shelter>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'shelters',
  ...
  @override
  Future<String> createNewShelter(Shelter shelter) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(shelter.toJson());
    final _options = _setStreamType<String>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  @override
  Future<GeneratedCrisisResponse> reportCrisisWithAI(
    ReportCrisisRequestBody reportCrisis,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(reportCrisis.toJson());
    final _options = _setStreamType<GeneratedCrisisResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'crisis/create',
  ...
  @override
  Future<List<GeneratedCrisisResponse>> getAllCrisis() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<GeneratedCrisisResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'crisis/all',
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<GeneratedCrisisResponse> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                GeneratedCrisisResponse.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
  ...
  @override
  Future<GeneratedCrisisResponse> markCrisisAsResolved(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<List<LeaderboardResponse>> getLeaderBoard() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<LeaderboardResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'users/top-helpers',
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<LeaderboardResponse> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                LeaderboardResponse.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
